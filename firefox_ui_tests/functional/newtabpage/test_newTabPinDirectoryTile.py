...
class NewTabPagePinDirectory(NewTabPageTestCase):

    """ Pin one of the default directory tiles 
        and verify that it stays in place after
        additional history tiles are added 
    """

    def test_pin_directory_second_tile(self):
